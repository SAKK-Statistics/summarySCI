...
The default test and CI types for continuous variable is `t.test`. This
can\
...
For categorical variables, the default test type is `fisher.test` and
the default CI types is `wilson`. This can\
be changed in `test_cat` and `ci_cat`, respectively.
