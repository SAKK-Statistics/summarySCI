...
Equivalently, labels can be added directly in the datase.

## Add number of observations 

The number of obervations can be added as a column seting the 
...
The defaults in `summaryTable` are different from the default in
`gtsummary::tbl_summary`. 

The following rules apply: 

- factor variables: !!! What about categorical variables wih two levels? are they 
considered as dichotomous? Check that! And then write the rest. 
